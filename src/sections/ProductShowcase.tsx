    ...
    <section className='bg-gradient-to-b from-[#fff] to-[#d2dcff] py-24 overflow-x-clip'>
      <div className="container">
        <div className="max-w-[540px] mx-auto">
          ...
          <h2 className='text-center text-3xl md:text-[54px] md:leading-[60px] font-bold tracking-tighter bg-gradient-to-b from-black to-[#001e80] text-transparent bg-clip-text mt-5'>A more effective to track progress</h2>
